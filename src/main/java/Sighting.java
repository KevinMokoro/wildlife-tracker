...
public class Sighting {
  ...
  public List<GeneralAnimal> getRegularAnimals(){
    try(Connection con = DB.sql2o.open()){
      ...
      return con.createQuery(sql).addParameter("id", this.id).throwOnMappingFailure(false).executeAndFetch(GeneralAnimal.class);
    }
  }
