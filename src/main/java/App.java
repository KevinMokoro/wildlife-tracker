...
public static void main(String[] args) {
        ...
        get("/animals", (request, response)->{
                        Map<String, Object> model = new HashMap<String, Object>();
                        model.put("rangerName", request.session().attribute("rangerName"));
                        model.put("general_animals", GeneralAnimal.all());
        ...
        post("/animals/new", (request, response)->{
                        ...
                        if(endangered) {
                                ...
                                GeneralAnimal generalAnimal = new GeneralAnimal(name, species);
                                generalAnimal.save();
                        }
        ...
        post("/sightings/new", (request, response)->{
                        ...
                        for(String animalName : animalArray) {
                                animal = GeneralAnimal.findByName(animalName);
                                if(animal == null) {
                                ...
                                if(animal != null) {
                                        ...
                                        throw new NullPointerException("I'm sorry, We couldn't find your animal. Please add it to the records and update your sighting");
                                }
                        }
